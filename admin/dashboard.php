...
<head>
    ...
    <link rel="stylesheet" href="/web-social-network/assets/css/dashboard.css">
    <link rel="stylesheet"
    ...
    <div class="layout">
        ...
        <aside class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="reports.php"><i class="fa-solid fa-flag"></i></i> Báo cáo</a></li>
            </ul>
        ...
        <main class="main">
            ...
            <section class="content">
                ...
                <section class="table-box">
                    ...
                    <table>
                        ...
                        foreach ($top_users as $user) { ?>
                            <tr>
                                <td>
                                    <img style="width: 30px; height: 30px;border-radius: 42px;position: relative;top: 8px;" src="<?= $user['Avatar'] ?>" alt="">
                                    <?= $user['FullName'] ?>
                                </td>
                ...
                <section class="table-box">
                    ...
                    <?php
                    $sql_top_post = "SELECT p.PostID, p.Content,img.ImageUrl,img.ImageID, u.FullName, p.LikeCount, p.CommentCount, TIMESTAMPDIFF(HOUR, p.UpdatedAt, CURRENT_TIME) as 'hours'
                                    FROM posts p
                    ...
                    <div class="top_post_container">
                        ...
                        <img src="<?= $top_post['ImageUrl'] ?>" alt="" class="top_post_img">
                        <div class="top_post_content">
                            <h4 style=""><?= $top_post['Content'] ?></h4>
                            <p>Đăng bởi <strong><?= $top_post['FullName'] ?></strong></p>
                            <span><?= $top_post['hours'] ?> giờ trước</span>
